...
jags.params <- c('tau1','tau2','lambda','betaHat','gammaHat','var.tt','var.s','var.t','tauDiff','Ynew','ttNew','Mnew')
...
modDinD <- jags(data=jags.data,parameters=jags.params,n.iter=10,model.file='code/totalModel.jags')
modDinD2 <- autojags(modDinD,n.iter=1000)

save(modDinD2,file='modTime2cat.RData')
